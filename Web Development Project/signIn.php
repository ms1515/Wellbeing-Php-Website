...
<body>
    ...
    <div class="container-fluid" id="loginContainer">
        ...
        <div class="container-fluid">
            <form class="needs-validation" action="secure/login/signInUser.php" method="POST" novalidate>
                ...
                <div id="submitButton">
                            <button type="submit" id="submitButton" name="signInRequest">
                                <h2>Sign in</h2>
                            </button>
                </div>
            </form>
            ...
            <div class="container-fluid">
               <p id="loginSignUpText">Don't have an account? <a href="signUp.php" id="loginSignUpButton">Sign Up</a></p>
               <p id="errorMessage"> 
                   <?php
                   if (isset($_SESSION['signInError'])) {
                       $errorMessage = $_SESSION['signInError'];
                       unset($_SESSION['signInError']);
                       echo "Error Signing in: $errorMessage";
                   }
                   ?>
               </p>
            </div>
